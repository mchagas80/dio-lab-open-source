...
4. Crie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`: `git checkout -b feat/community/mchagas80`;
    > Exemplo: `git checkout -b feat/community/mchagas80`
